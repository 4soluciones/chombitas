    ...
    w = Oa.Chart = function () {
        ...
        m.prototype._processStackedPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], u = [], z = Infinity, h = -Infinity, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var n =
                        this.data[a.dataSeriesIndexes[p]], q = 0, g = !1, A = !1, k;
                    ...
                    for (q = 0; q < n.dataPoints.length; q++) {
                        ...
                        if (b < O && !g) null !== n.dataPoints[q].y && (k = b); else {
                            ...
                            if (b > t && !A) A = !0; else if (b > t && A) continue;
        ...
        m.prototype._processStacked100PlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, u = !1, z = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                    var p = this.data[a.dataSeriesIndexes[h]], n = 0, q = !1, g = !1, A;
        ...
        m.prototype._processMultiYPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, u = !1, z = 0; z < a.dataSeriesIndexes.length; z++) {
                var h = this.data[a.dataSeriesIndexes[z]], p = 0, n = !1, q = !1, g, A, k;
        ...
        m.prototype.validateRegion = function (a, d, c, b, e) {
            ...
            for (l = 0; l < h.length; l++) {
                ...
                if (q > g) var A = g, g = q, q = A;
                if (n.scaleBreaks) for (A = 0; !f && A < n.scaleBreaks._appliedBreaks.length; A++) f = n.scaleBreaks._appliedBreaks[A].startValue <= q && n.scaleBreaks._appliedBreaks[A].endValue >= g;
                if (isFinite(n.dataInfo.minDiff)) if (A = n.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && (n.logarithmic && A < Math.pow(n.dataInfo.minDiff,
        ...
        m.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                var l = ma("indexLabelFontWeight", h.dataPoint, h.dataSeries),
                    ...
                    f = ma("indexLabelWrap", h.dataPoint, h.dataSeries), A = ma("indexLabelLineDashType",
                ...
                if (null !== C && "" !== C) {
                    var t = ma("indexLabelPlacement", h.dataPoint, h.dataSeries),
                        ...
                        B = h.dataSeries.axisX, y = h.dataSeries.axisY, v = !1, g = new la(d, {
                            x: 0,
                            y: 0,
        ...
        m.prototype.renderLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    if (c.setLineDash) {
                        var q = Q(h.nullDataLineDashType,
                            h.lineThickness), n = h.lineDashType, g = Q(n, h.lineThickness);
                        c.setLineDash(g)
                    }
                    var A = h.id;
                    ...
                    var A = h._colorSet, k = A = h.lineColor = h.options.lineColor ? h.options.lineColor : A[0];
                    c.strokeStyle = A;
                    var m = !0, t = 0, x, r;
                    c.beginPath();
                    if (0 < p.length) {
                        for (var J = !1, t = 0; t < p.length; t++) if (x = p[t].x.getTime ? p[t].x.getTime() : p[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax &&
                            (!h.connectNullData || !J))) if ("number" !== typeof p[t].y) 0 < t && !(h.connectNullData || J || m) && (c.stroke(), s && b.stroke()), J = !0; else {
                ...
                return {
                    ...
                    animationCallback: L.xClipAnimation, easingFunction: L.easing.linear, animationBase: 0
                }
            }
        };
        m.prototype.renderStepLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    c.beginPath();
                    if (0 < p.length) {
                        for (var J = !1, t = 0; t < p.length; t++) if (x = p[t].getTime ? p[t].x.getTime() :
                            p[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !J))) if ("number" !== typeof p[t].y) 0 < t && !(h.connectNullData || J || m) && (c.stroke(), s && b.stroke()), J = !0; else {
                            var B = r;
                            x = a.axisX.convertValueToPixel(x);
                            r = a.axisY.convertValueToPixel(p[t].y);
        ...
        m.prototype.renderSpline = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = [], u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    var m = 0, t, x, r = [];
                    b.beginPath();
                    if (0 < p.length) for (x = !1, m = 0; m < p.length; m++) if (t = p[m].getTime ? p[m].x.getTime() : p[m].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !x))) if ("number" !== typeof p[m].y) 0 < m && !x && (h.connectNullData ? b.setLineDash && (0 <
                        r.length && (h.options.nullDataLineDashType || !p[m - 1].lineDashType)) && (r[r.length - 1].newLineDashArray = q, n = h.nullDataLineDashType) : (d(r), r = [])), x = !0; else {
        ...
        m.prototype.renderColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var q =
                        a.dataSeriesIndexes[p], g = this.data[q], A = g.dataPoints;
                    if (0 < A.length) for (var k = 5 < n && g.bevelEnabled ? !0 : !1, f = 0; f < A.length; f++) if (A[f].getTime ? z = A[f].x.getTime() : z = A[f].x, !(z < a.axisX.dataInfo.viewPortMin || z > a.axisX.dataInfo.viewPortMax) && "number" === typeof A[f].y) {
        ...
        m.prototype.renderStackedColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                    var k = a.dataSeriesIndexes[A], m = this.data[k], t = m.dataPoints;
                    if (0 < t.length) {
                ...
                for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                    ...
                    if (0 < t.length) for (var r = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < t.length; h++) if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                        ...
                        if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) {
                            ...
                            B = f[b] ? f[b] : q;
                            f[b] = n
                        } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) z[b] = n + ("undefined" !== typeof z[b] ? z[b] : 0), B = a.axisY.convertValueToPixel(z[b]), n = l[b] ? l[b] : q, l[b] = B; else if (n = a.axisY.convertValueToPixel(n), 0 <= t[h].y) {
                        ...
                        (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            point: {x: p, y: 0 <= t[h].y ? n : B},
                            direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1,
                            bounds: {x1: C, y1: Math.min(n, B), x2: J, y2: Math.max(n, B)},
                            color: b
                        })
                    }
                }
        ...
        m.prototype.renderBar =
            function (a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    s && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip());
                    for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                        var q = a.dataSeriesIndexes[p], g = this.data[q], A = g.dataPoints;
                        if (0 < A.length) {
                            var k = 5 < n && g.bevelEnabled ? !0 : !1;
                            c.strokeStyle = "#4572A7 ";
                            for (f = 0; f < A.length; f++) if (A[f].getTime ? z = A[f].x.getTime() : z = A[f].x, !(z <
                ...
                for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++) if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                            ...
                            var C = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, J = C + g << 0, B;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) u[b] = t[h].y + (u[b] ? u[b] : 0), 0 < u[b] && (B = f[b] ? f[b] : q, f[b] = p = a.axisY.convertValueToPixel(u[b])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                                0 >= t[h].y) z[b] = t[h].y + (z[b] ? z[b] : 0), p = l[b] ? l[b] : q, l[b] = B = a.axisY.convertValueToPixel(z[b]); else if (p = a.axisY.convertValueToPixel(t[h].y), 0 <= t[h].y) {
                                var y = f[b] ? f[b] : 0;
                                B = q + y;
                                p += y;
                                f[b] = y + (p - B)
                            ...
                            (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1,
                                bounds: {x1: Math.min(B, p), y1: C, x2: Math.max(B, p), y2: J},
                                color: b
                            })
                        }
                    }
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                        ...
                        if (0 < t.length) {
                            var r = 5 < g && m.bevelEnabled ? !0 : !1;
                            c.strokeStyle = "#4572A7 ";
                            for (h = 0; h < t.length; h++) if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin ||
                                b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                n = a.axisX.convertValueToPixel(b);
                                var C;
                                C = 0 !== a.dataPointYSums[b] ? 100 * (t[h].y / a.dataPointYSums[b]) : 0;
                                var J = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, B = J + g << 0;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) {
                                    u[b] = C + (u[b] ? u[b] : 0);
                                    if (0 >= u[b]) continue;
                                    C = f[b] ? f[b] : q;
                                    ...
                                    C + (z[b] ? z[b] : 0), p = l[b] ? l[b] : q, l[b] = C = a.axisY.convertValueToPixel(z[b]); else if (p = a.axisY.convertValueToPixel(C), 0 <= t[h].y) {
                                    var y = f[b] ? f[b] : 0;
                                    C = q + y;
                                    p += y;
                                ...
                                (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                                    ...
                                    direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1,
                                    bounds: {x1: Math.min(C, p), y1: J, x2: Math.max(C, p), y2: B},
                                    color: b
                                })
                            }
                        }
        ...
        m.prototype.renderArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var q = a.dataSeriesIndexes[n], g = this.data[q], A = g.dataPoints, z = g.id;
                    ...
                    d = !0;
                    var k = 0, m, t, r,
                        C = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), J, B = null;
                    if (0 < A.length) {
                        ...
                        for (var ha = !0; k < A.length; k++) if (r = A[k].x.getTime ?
                            A[k].x.getTime() : A[k].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ha))) if ("number" !== typeof A[k].y) g.connectNullData || (ha || d) || b(), ha = !0; else {
                            ...
                            this._eventManager.objectMap[$] = {
                                ...
                                dataSeriesIndex: q, dataPointIndex: k, x1: m, y1: t
                            };
                ...
                f.restore();
                return {
                    source: e, dest: this.plotArea.ctx, animationCallback: L.xClipAnimation,
            ...
            function d() {
                ...
                if (0 < c.length) {
                    if (0 < p.lineThickness) {
                        ...
                        for (var d = 0; d < c.length - 3; d += 3) if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), s && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle ||
                ...
                for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    if (0 < n.length) {
                        var C = p._colorSet[q % p._colorSet.length],
                            J = p.lineColor = p.options.lineColor || C, B = J;
                        b.fillStyle = C;
                        b.strokeStyle = J;
                        ...
                        for (A = !1; q < n.length; q++) if (g = n[q].x.getTime ? n[q].x.getTime() : n[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !A))) if ("number" !== typeof n[q].y) 0 < q && !A && (p.connectNullData ? b.setLineDash && (0 < r.length && (p.options.nullDataLineDashType ||
                            !n[q - 1].lineDashType)) && (r[r.length - 1].newLineDashArray = w, y = p.nullDataLineDashType) : (d(), r = [])), A = !0; else {
                            ...
                            (n[q].indexLabel || p.indexLabel || n[q].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "splineArea", dataPoint: n[q], dataSeries: p,
                                point: {x: g, y: A}, direction: 0 > n[q].y === a.axisY.reversed ? 1 : -1, color: C
                            });
                            A = !1
                        }
                        d();
        ...
        m.prototype.renderStepArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var q =
                        a.dataSeriesIndexes[n], g = this.data[q], A = g.dataPoints, z = g.id;
                    ...
                    if (0 < A.length) {
                        ...
                        if (f.setLineDash) {
                            var P = Q(g.nullDataLineDashType, g.lineThickness),
                                K = g.lineDashType, D = Q(K, g.lineThickness);
                            f.setLineDash(D)
                        }
                        for (; k < A.length; k++) if (r = A[k].x.getTime ? A[k].x.getTime() : A[k].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                            var $ = t;
        ...
        m.prototype.renderStackedArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = [], u = this.plotArea, z = [], h = [], p = [], n = [], q = 0, g, k,
                    ...
                    r = this._eventManager.ghostCtx, t, x, C;
                s && r.beginPath();
                b.save();
                s && r.save();
                b.beginPath();
                ...
                for (var e = [], J = 0; J < a.dataSeriesIndexes.length; J++) {
                    var B =
                        a.dataSeriesIndexes[J], y = this.data[B], v = y.dataPoints;
                    y.dataPointIndexes = [];
        ...
        m.prototype.renderStackedArea100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var e = [], v = 0; v < a.dataSeriesIndexes.length; v++) {
                    var B = a.dataSeriesIndexes[v], y = this.data[B], w = y.dataPoints;
                    y.dataPointIndexes = [];
                ...
                for (v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < p.length) {
                        var e =
                            y._colorSet[q % y._colorSet.length], D = y.lineColor = y.options.lineColor || e, K = D;
                        b.fillStyle = e;
                        b.strokeStyle = D;
                        b.lineWidth = y.lineThickness;
                        t = "solid";
                        ...
                        for (var $ = !0, q = 0; q < p.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!y.connectNullData || !$))) if ("number" !== typeof ia.y) y.connectNullData ||
                            ($ || O) || d(), $ = !0; else {
                                var na;
        ...
        m.prototype.renderBubble = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var u = -Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++) for (var p = a.dataSeriesIndexes[h], n = this.data[p], q = n.dataPoints,
                ...
                for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    if (0 < p.length) {
                        ...
                        Math.pow(0.3 * Math.min(b.height,
                            b.width) / 2, 2);
                        for (var n = 0, q = 0, e = 0; e < p.length; e++) if (f = p[e].getTime ? f = p[e].x.getTime() : f = p[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[e].y) {
                            f = a.axisX.convertValueToPixel(f);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = this.plotArea, u = 0, k, h, p, n, q, g,
                    ...
                    f = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ?
                        this.dataPointWidth : 0.015 * this.width, m = a.axisX.dataInfo.minDiff;
                ...
                for (var ga = 0; ga < a.dataSeriesIndexes.length; ga++) {
                    ...
                    if (0 < x.length) for (var C = 5 < m && t.bevelEnabled ? !0 : !1, u = 0; u < x.length; u++) if (x[u].getTime ? g = x[u].x.getTime() : g = x[u].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(x[u].y) && x[u].y.length && "number" === typeof x[u].y[0] &&
                    "number" === typeof x[u].y[1] && "number" === typeof x[u].y[2] && "number" === typeof x[u].y[3]) {
                        ...
                        (x[u].indexLabel || t.indexLabel ||
                            ...
                            direction: 1,
                            bounds: {x1: v, y1: Math.min(p, n), x2: B, y2: Math.max(p, n)},
                            color: e
                        })
                    }
                }
        ...
        m.prototype.renderBoxAndWhisker = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var ga = !1, ga = !!a.axisY.reversed, O = 0; O < a.dataSeriesIndexes.length; O++) {
                    var t = a.dataSeriesIndexes[O], x = this.data[t], C = x.dataPoints;
                    if (0 < C.length) for (var v = 5 < m && x.bevelEnabled ? !0 : !1, l = 0; l < C.length; l++) if (C[l].getTime ? g = C[l].x.getTime() : g = C[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(C[l].y) && C[l].y.length && "number" === typeof C[l].y[0] && "number" === typeof C[l].y[1] && "number" === typeof C[l].y[2] && "number" === typeof C[l].y[3] && "number" === typeof C[l].y[4] && 5 === C[l].y.length) {
                        ...
                        var B = u - m / 2 << 0, y = u + m / 2 << 0, e = C[l].color ? C[l].color : x._colorSet[0],
                            w = Math.round(Math.max(1, 0.15 * m)), D = 0 === w % 2 ? 0 : 0.5,
                            ...
                            F = 1 === Math.round(ca) % 2 ? 0.5 : 0, I = C[l].stemDashType ? C[l].stemDashType :
                            x.stemDashType,
                        ...
                        (C[l].indexLabel || x.indexLabel || C[l].indexLabelFormatter ||
                            ...
                            direction: 1,
                            bounds: {x1: B, y1: Math.min(k, n), x2: y, y2: Math.max(k, n)},
                            color: e
                        })
                    }
                }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < g.length) for (var m =
                        5 < h && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++) if (g[f].getTime ? k = g[f].x.getTime() : k = g[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
                        ...
                        var ga = a.axisX.reversed ? b + a.plotType.totalDataSeries * h / 2 - (a.previousDataSeriesCount + p) * h << 0 : b - a.plotType.totalDataSeries * h / 2 + (a.previousDataSeriesCount +
                            p) * h << 0, O = a.axisX.reversed ? ga - h << 0 : ga + h << 0,
            ...
            function (a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                        var C = a.dataSeriesIndexes[x], v = this.data[C], B = v.dataPoints,
                            y = r(v._linkedSeries) ? !1 : v._linkedSeries.type.match(/(bar|column)/ig) && v._linkedSeries.visible ? !0 : !1,
                            D = 0;
                        if (y) for (e = v._linkedSeries.id, t = 0; t < e; t++) !this.data[t].type.match(/(bar|column)/ig) ||
                        ...
                        e && (t = e);
                        t > u && (t = u);
                        if (0 < B.length) for (var E = v._colorSet, u = 0; u < B.length; u++) {
        ...
        m.prototype.renderRangeArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
                    var k = [], h = a.dataSeriesIndexes[u], p = this.data[h], n = p.dataPoints, f = p.id;
                    this._eventManager.objectMap[f] = {objectType: "dataSeries", dataSeriesIndex: h};
                    f = S(f);
                    e.fillStyle = f;
                    var f = [], q = !0, g = 0, m, r, v, t, x = null;
                    if (0 < n.length) {
                        var C = p._colorSet[g % p._colorSet.length], w = p.lineColor = p.options.lineColor || C, B = w;
                        b.fillStyle = C;
                        b.strokeStyle = w;
                        b.lineWidth = p.lineThickness;
                        var y = "solid";
                        if (b.setLineDash) {
                            var D = Q(p.nullDataLineDashType, p.lineThickness), y = p.lineDashType, E = Q(y,
                                p.lineThickness);
                            b.setLineDash(E)
                        }
                        for (var K = !0; g < n.length; g++) if (t = n[g].x.getTime ? n[g].x.getTime() : n[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !K))) if (null !== n[g].y && n[g].y.length && "number" === typeof n[g].y[0] && "number" === typeof n[g].y[1]) {
        ...
        m.prototype.renderRangeSplineArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                    ...
                    var f = [], n = 0, q, g, A, r = [], O = [];
                    if (0 < p.length) {
                        var t = h._colorSet[n % h._colorSet.length], x = h.lineColor = h.options.lineColor || t, C = x;
                        b.fillStyle = t;
                        b.lineWidth = h.lineThickness;
                        var w = "solid", B;
                        if (b.setLineDash) {
                        ...
                        for (g = !1; n < p.length; n++) if (q = p[n].x.getTime ? p[n].x.getTime() : p[n].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData ||
                            !g))) if (null !== p[n].y && p[n].y.length && "number" === typeof p[n].y[0] && "number" === typeof p[n].y[1]) {
                            ...
                            if (0 !== p[n].markerSize && (0 < p[n].markerSize || 0 < h.markerSize)) {
                                ...
                                K = S(D);
                                s && f.push({
                                    x: q, y: A, ctx: e, type: E.type, size: E.size,
                                    color: K, borderColor: K, borderThickness: E.borderThickness
                                })
                            }
        ...
        m.prototype.renderWaterfall = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx, e = null, f = this.plotArea, l = 0, k, m, h, p,
                    n = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    var r = a.dataSeriesIndexes[g], v = this.data[r], O = v.dataPoints, e = v._colorSet[0];
                    ...
                    if (0 < O.length) for (var C = 5 < q && v.bevelEnabled ? !0 : !1, w = !1, B = null, y = null, l = 0; l < O.length; l++) if (O[l].getTime ?
        ...
        m.prototype.renderPie = function (a) {
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < p.length) {
                    ...
                    for (n = 1; n < p.length; n++) if (l = (a - n + g.length) % g.length, g[l].hemisphere !== g[a].hemisphere) {
                        ...
                        g[a].indexLabelTextBlock.y : g[l].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y))) break; else l = null;
                    q = l;
                    k = e(a);
                    n = l = 0;
            ...
            function l() {
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    ...
                    } else for (a = 0; a < p.length; a++) k = g[a], s = "pie" === h.type ? 0.7 * y : 0.8 * y, r = C.x + s * Math.cos(k.midAngle), t = C.y + s * Math.sin(k.midAngle), k.indexLabelTextBlock.x = r, k.indexLabelTextBlock.y = t;
                    for (a = 0; a < p.length; a++) if (k = g[a], r = k.indexLabelTextBlock.measureText(), 0 !== r.height && 0 !== r.width) r = r = 0, "right" === k.hemisphere ? (r = q.x2 - (k.indexLabelTextBlock.x + k.indexLabelTextBlock.width + n), r *= -1) : r = q.x1 - (k.indexLabelTextBlock.x - k.indexLabelTextBlock.width - n), 0 < r && (!l && k.indexLabelText &&
                                ...
                                if (m = 0 > B) {
                                    ...
                                    var q = u.indexLabelTextBlock.y - u.indexLabelTextBlock.height / 2,
                                        ...
                                        r = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height /
                                            2, A = k.indexLabelTextBlock.x + k.indexLabelTextBlock.width,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var h = this.data[a.dataSeriesIndexes[0]], p = h.dataPoints, n = 10, q = this.plotArea,
                    g = h.dataPointEOs, A = 2, s, v = 1.3, t = 20 / 180 * Math.PI,
                    x = 6, C = {x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2}, w = 0;
                a = !1;
                    ...
                    this._animator.animate(0,
                        this.animatedRender ? this.animationDuration : 0, function (a) {
                            ...
                            for (b = 0; b < p.length; b++) {
                                var c = 0 === b ? g[b].startAngle : d, d = c + (g[b].endAngle - g[b].startAngle),
                                    e = !1;
                                d > a && (d = a, e = !0);
        ...
        m.prototype.renderFunnel = function (a) {
            ...
            function e() {
                ...
                if (e) for (l = H.length - 1; 0 <= l; l--) a = R[l], H[l].textBlock.maxWidth = f[f.length - (l + 1)], H[l].textBlock.measureText(), H[l].textBlock.x = N - h, c = H[l].textBlock.height <
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                var P = C.x1 + B, N = C.x2 - B, $ = C.y1 + D, T = C.y2 - D,
                ...
                if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
                    ...
                    var B = P + a / 2, X = P, aa = P + a, U = t.reversed ? T : $, M = B - F / 2, Y = B + F / 2,
                        xa = t.reversed ? $ + ca : T - ca, sa = t.reversed ? $ : T;
                    a = [];
                    var B = [], R = [], G = [], V = $, da, ba = (xa - U) / (M - X), fa = -ba,
                    ...
                    if (-1 !== P) {
                        ...
                        if (t.reversed) for (F = 0; F < P.length; F++) G[F] < xa ? (a.push(M), B.push(Y), da = F) : (a.push((G[F] - U + ba * X) / ba), B.push((G[F] - U + fa * aa) / fa)); else for (F = 0; F < P.length; F++) G[F] < xa ? (a.push((G[F] - U + ba * X) / ba), B.push((G[F] - U + fa * aa) / fa), da = F) : (a.push(M), B.push(Y));
        ...
        m.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
                ...
                } else return fa(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = "#,##0.########", f._cultureInfo); else return "y" ===
        ...
        E.prototype.setLayout = function () {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(),
                c = null, b = 0, e = 0, f = 0, l = 0, k = this.markerMargin = this.chart.options.legend &&
            ...
            for (var p = 0; p < this.dataSeries.length; p++) {
                ...
                if (n.dataPoints && n.dataPoints.length) if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type && "pyramid" !== n.type) {
                    ...
                    var w = n.dataPoints[x],
                        ...
                        g = this.chart.replaceKeywordsWithValue(g, w, n, x), q = {
                            markerType: q,
                            markerColor: A,
                            text: g,
                            textBlock: null,
        ...
        G.prototype.getDataPointAtX = function (a, d) {
            ...
            var c = {
                ...
                index: NaN
            }, b = null, e = 0, f = 0, l = 1, k = Infinity, m = 0, h = 0, p = 0;
        ...
        G.prototype.getDataPointAtXY = function (a, d, c) {
            ...
            c = c || !1;
            var b = [], e = 0, f = 0, l = 1, k = !1, m = Infinity, h = 0, p = 0, n = 0;
            if ("none" !== this.chart.plotInfo.axisPlacement) if (n = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({
                ...
                n = 1 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * Math.log(n /
                    this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0; else q = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, n = 0 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * (n - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;
            for (; ;) {
                f = 0 < l ? n + e : n - e;
                if (0 <= f && f < this.dataPoints.length) {
        ...
        D.prototype.createLabels = function () {
            ...
            e = [];
            q = n = 0;
            if (this.labelAutoFit || this.options.labelAutoFit) if (r(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position ||
        ...
        D.setLayout = function (a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++) if (q[g] && q[g].scaleBreaks &&
                q[g].scaleBreaks._appliedBreaks.length) for (var A = q[g].scaleBreaks._appliedBreaks, s = 0; s < A.length && !(A[s].startValue > q[g].viewportMaximum); s++) A[s].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = s), A[s].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = s));
            ...
            if ("normal" === e) {
                ...
                s;) {
                    ...
                    S.push(D);
                    if (b && 0 < b.length) for (B = [], g = ba = 0; g < b.length; g++) B.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), ba += B[g], aa += b[g] ? b[g].margin : 0; else B.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                    T.push(B);
                    ...
                    if (0 < s) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++) A = N[s - 1][g] === N[s][g] ? !0 : !1; else A = !0;
                ...
                for (Q = []; 4 > s;) {
                    ...
                    if (b && 0 < b.length) for (g = 0; g < b.length; g++) b[g].lineCoordinates = {}, l = Math.round(f.x1 + X + e), m = Math.round(f.x2 - V - Z > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - V - Z), b[g] && b[g].labelAutoFit && !r(D) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, D) : 0 === b[g].labelAngle ? Math.max(l, D / 2) : l), 0 < !d.length && (m -= B / 2)), b[g].lineCoordinates.x1 = l, b[g].lineCoordinates.x2 = m, b[g].lineCoordinates.width = Math.abs(m - l), b[g].title && (b[g]._titleTextBlock.maxWidth =
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if (E) {
                            if ("axisX" === this.parent.type) for (s =
                                                                       this.parent.convertPixelToValue({y: d}), v = null, w = 0; w < this.parent.dataSeries.length; w++) (v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (h.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: x.dataPoint.x
                            ...
                            chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c :
                                x.dataPoint.x
                    ...
                    this.bounds = {x1: b - n / 2, y1: f, x2: e + n / 2, y2: l};
                    E = !1;
                    if (this.parent.labels) for (p = Math.ceil(this.parent.interval), s = 0; s < this.parent.viewportMaximum; s +=
                        p) if (this.parent.labels[s]) E = !0; else {
                        E = !1;
                        break
                    }
                    if (E) {
                    ...
                    w = 0;
                    if ("rangeColumn" === p[0].dataSeries.type || "rangeArea" === p[0].dataSeries.type || "error" === p[0].dataSeries.type || "rangeSplineArea" === p[0].dataSeries.type || "candlestick" === p[0].dataSeries.type || "ohlc" === p[0].dataSeries.type || "boxAndWhisker" === p[0].dataSeries.type) for (v =
                    ...
                    t < v && (v = t, w = s); else t = Math.abs(d - this.parent.convertValueToPixel(p[s].dataPoint.y)), t < v && (v = t, w = s);
                    x = p[w];
                    b = 0;
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled &&
                    ...
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        k = [];
                        if (this.chart.axisX) for (m = 0; m < this.chart.axisX.length; m++) for (l = this.chart.axisX[m].convertPixelToValue({x: a}), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++) (h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(l,
                            c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[b], null !== h.dataPoint.y && k.push(h));
                        if (this.chart.axisX2) for (m = 0; m < this.chart.axisX2.length; m++) for (l = this.chart.axisX2[m].convertPixelToValue({x: a}), h = null, b = 0; b < this.chart.axisX2[m].dataSeries.length; b++) (h = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(l, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX2[m].dataSeries[b], null !== h.dataPoint.y && k.push(h))
                    }
                    ...
                    if (h = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = h.dataPointIndex, this.currentSeriesIndex = h.dataSeries.index; else if (s) if (h = Ya(a, d, this.chart._eventManager.ghostCtx), 0 < h && "undefined" !== typeof this.chart._eventManager.objectMap[h]) {
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        if (!r(h) && !r(h.dataPoint) && !r(h.dataPoint.y)) if (h.dataSeries.axisY) if (0 <
        ...
        aa.prototype.getToolTipInnerHTML = function (a) {
            a = a.entries;
            for (var d = null, c = null, b = null, e = 0, f = "", l = !0, k = 0; k < a.length; k++) if (a[k].dataSeries.toolTipContent || a[k].dataPoint.toolTipContent) {
                l = !1;
                break
            }
